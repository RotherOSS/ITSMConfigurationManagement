...
package Kernel::System::ITSMConfigItem::Mask;
...
Kernel::System::ITSMConfigItem::Mask - functions to prepare and administrate config item masks

=head1 DESCRIPTION

functions to prepare and administrate config item masks
...
Don't use the constructor directly, use the ObjectManager instead:
    ...
    my $MaskObject = $Kernel::OM->Get('Kernel::System::ITSMConfigItem::Mask');
...
Get the definition for a config item mask
...
Delete the definition for a config item mask
