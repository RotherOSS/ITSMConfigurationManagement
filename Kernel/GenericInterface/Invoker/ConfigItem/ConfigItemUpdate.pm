...
package Kernel::GenericInterface::Invoker::ConfigItem::ConfigItemUpdate;
...
Kernel::GenericInterface::Invoker::ConfigItem::ConfigItemUpdate - GenericInterface ConfigItemUpdate Invoker backend

=head1 DESCRIPTION

Contains functions for ConfigItemUpdate.
