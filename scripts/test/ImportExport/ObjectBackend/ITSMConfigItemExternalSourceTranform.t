...
my @ImportDataTests = (
    {
        ...
        SourceImportData => {
            ...
            ImportDataSave => {
                TemplateID    => $TemplateID,
                ImportDataRow => [
                    'TestSubsidiary'.$RandomID,
                    'Production',
                    'Operational',
                    'München',
                    ["TestCountry$RandomID"],
                ],
                UserID => $TestUserID,
            },
        },
...
delete $DynamicFieldConfig->{Config}->{ImportSearchAttribute};
