...
# ObjectAttributesGet test 1 (check attribute hash)
{
    ...
    my $ObjectAttributesGet1Reference = [
        ...
        },
        {
            ...
            Name  => 'Maximum number of one Set dynamic field element',
            Input => {
                Type         => 'Text',
                ValueDefault => '0',
                Required     => 0,
        ...
        },
        {
            ...
            Name  => 'Maximum number of one element within a Set dynamic field element',
            Input => {
                Type         => 'Text',
                ValueDefault => '0',
                Required     => 0,
...
# create agents that will be referenced in Agent dynamic fields
my %Agent2UserID;
{
    my %LastName = (
