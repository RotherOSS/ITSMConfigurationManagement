...
my $URL = 'http://localhost/otobo/nph-genericinterface.pl/Webservice/GenericConfigItemConnectorSOAP';

# this name space should match the specified name space in the SOAP transport for the web service
my $NameSpace = 'http://www.otobo.org/ConfigItemConnector';
...
# check OTOBO Admin Manual in order to get the complete list
my $XMLData = '
