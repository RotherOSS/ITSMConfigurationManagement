...
/**
 * @namespace
 * @exports TargetNS as ITSM.Agent.DynamicFieldITSMConfigItemLensSearch
 * @description
 *      This namespace contains the special module functions for the contact data search.
 */
ITSM.Agent.DynamicFieldITSMConfigItemLensSearch = (function(TargetNS) {

    if (
        !Core.Debug.CheckDependency('ITSM.Agent.DynamicFieldITSMConfigItemLensSearch', 'Core.Config', 'Core.Config', true)
        )
    {
        return false;
    }
    ...
    /**
     * @name Init
     * @memberof ITSM.Agent.DynamicFieldITSMConfigItemLensSearch
     * @function
    ...
    TargetNS.Init = function() {
        ...
        function InitDynamicFields($Context) {
            ...
            if (
                ...
                && typeof AutoComplete.DynamicFieldITSMConfigItemLens !== 'undefined'
                && typeof AutoComplete.DynamicFieldITSMConfigItemLens.AutoCompleteActive !== 'undefined'
                )
            {
                AutoCompleteActive = AutoComplete.DynamicFieldITSMConfigItemLens.AutoCompleteActive !== '0'
                    ? true
                    : false;
            }

            $('.DynamicFieldITSMConfigItemLens', $Context).each(function () {
     ...
     * @description This function initializes the special module functions for every ConfigItem dynamic field
     */
    TargetNS.InitElement = function($Element, AutoCompleteActive) {
        var AutoCompleteConfig = Core.Config.Get('Autocomplete').DynamicFieldITSMConfigItemLens
            ? Core.Config.Get('Autocomplete').DynamicFieldITSMConfigItemLens
            : {
                MinQueryLength: 2,
                QueryDelay: 100,
            ...
            $Element.autocomplete({
                ...
                source: function(Request, Response) {
                    ...
                    var URL = Core.Config.Get('Baselink'),
                        Data = {
                            Action: 'AgentDynamicFieldITSMConfigItemLensSearch',
                            Term: Request.term,
            ...
            $Element.blur(function() {
                ...
                if (!$(this).val()) {
                    ...
                    $('.' + $(this).prevAll('input[type=hidden]').attr('id')).fadeOut('fast', function() {
                        ...
                        if (!$(this).find('.ConfigItem').hasClass('Hidden')) {
                            Visible = true;
                        }
                        $(this).remove();
    ...
    return TargetNS;
}(ITSM.Agent.DynamicFieldITSMConfigItemLensSearch || {}));
